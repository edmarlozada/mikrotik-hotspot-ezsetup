...
#/ip dhcp-client set [find  interface=$bridgeW01] use-peer-dns=no comment=$brg1WNote disabled=no

# google dns
#/ip dhcp-client set [find interface=[/interface get [find default-name=ether1] name]] use-peer-dns=no
#/ip dns set servers=(208.67.222.222,8.8.8.8,1.1.1.1)
...
# ------------------------------
:console clear }
/file remove "1_mikrotik_config/1_config_basic.rsc"
/file remove "1_mikrotik_config/2_config_advance.rsc"
